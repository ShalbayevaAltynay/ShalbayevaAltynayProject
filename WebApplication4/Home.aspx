...
<body style="height: 1287px">
    <form id="form1" runat="server">
        <div class="auto-style1">
            
            <div style="text-align: center;"><img src="headerallphoto.png"></div>
            ...
            &nbsp;&nbsp;&nbsp;
            <br />
            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Verdana Pro" Font-Size="15pt" Text="Image slider"></asp:Label>
            <asp:Timer ID="Timer1" runat="server" Interval="2000" OnTick="Timer1_Tick">
            </asp:Timer>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Image ID="Image1" runat="server" BorderStyle="Solid" Height="500px" ImageAlign="Middle" Width="1000px" />
            <br />
            <br />
            <br />
            <br />
